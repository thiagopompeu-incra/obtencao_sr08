...
var format_AssentamentosSP_4 = new ol.format.GeoJSON();
var features_AssentamentosSP_4 = format_AssentamentosSP_4.readFeatures(json_AssentamentosSP_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AssentamentosSP_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AssentamentosSP_4.addFeatures(features_AssentamentosSP_4);
var lyr_AssentamentosSP_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_AssentamentosSP_4, 
                style: style_AssentamentosSP_4,
                popuplayertitle: 'Assentamentos (SP)',
                interactive: true,
    title: 'Assentamentos (SP)<br />\
    <img src="styles/legend/AssentamentosSP_4_0.png" /> Adjudicação<br />\
    <img src="styles/legend/AssentamentosSP_4_1.png" /> Arrecadação<br />\
    <img src="styles/legend/AssentamentosSP_4_2.png" /> Cessão<br />\
    <img src="styles/legend/AssentamentosSP_4_3.png" /> Cessão Gratuita<br />\
    <img src="styles/legend/AssentamentosSP_4_4.png" /> Compra e Venda<br />\
    <img src="styles/legend/AssentamentosSP_4_5.png" /> Desapropriação<br />\
    <img src="styles/legend/AssentamentosSP_4_6.png" /> Reconhecimento<br />\
    <img src="styles/legend/AssentamentosSP_4_7.png" /> Transferência<br />\
    <img src="styles/legend/AssentamentosSP_4_8.png" /> <br />' });
...
lyr_GoogleHybrid_0.setVisible(false);lyr_MunicpiosSP_1.setVisible(true);lyr_ValorMdiodaTerraporMRTRAMT2022_2.setVisible(false);lyr_reasquilombolasSP_3.setVisible(false);lyr_AssentamentosSP_4.setVisible(false);lyr_ImveisemobtenoSP_5.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_MunicpiosSP_1,lyr_ValorMdiodaTerraporMRTRAMT2022_2,lyr_reasquilombolasSP_3,lyr_AssentamentosSP_4,lyr_ImveisemobtenoSP_5];
...
lyr_AssentamentosSP_4.set('fieldImages', {'id': 'TextEdit', 'Name': 'TextEdit', 'description': 'TextEdit', 'timestamp': 'DateTime', 'begin': 'DateTime', 'end': 'DateTime', 'altitudeMode': 'TextEdit', 'tessellate': 'Range', 'extrude': 'Range', 'visibility': 'Range', 'drawOrder': 'Range', 'icon': 'TextEdit', 'cd_sipra': 'TextEdit', 'nome_proje': 'TextEdit', 'area_hecta': 'TextEdit', 'capacidade': 'Range', 'num_famili': 'Range', 'fase': 'Range', 'data_de_cr': 'TextEdit', 'forma_obte': 'TextEdit', 'data_obten': 'TextEdit', });
...
lyr_ImveisemobtenoSP_5.on('precompose', function(evt) {
